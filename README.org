...
| *Content*                                          | *Site*                  |
| Postal Diplomacy Zine archive                      | [[http://whiningkentpigs.com/DW/kent/diplomacyzinearchive.htm][whiningkentpigs.com]]     |
...
| http://whitehall-paraindustries.blogspot.com/                          | Whitehall Paraindustries - Blog about game design and age of heroes                                |     |
...
#+ATTR_HTML: :border 2 :rules all :frame border
#+ATTR_LATEX: :environment longtable :align p{8cm}p{6cm}
| *Site*                                                                   | *Tool*                                       |
|                                                                          | *Online dice*                                |
| https://www.wizards.com/dnd/dice/dice.htm                                | Online WotC dice rolls                       |
|                                                                          | *Numbers*                                    |
| http://donjon.bin.sh/d20/dungeon                                         | D20 Random Dungeon Generator and other tools |
|                                                                          | *A*                                          |
| https://anydice.com/                                                     | All dice statistics                          |
|                                                                          | *B*                                          |
| [[http://2ndage.blogspot.com/2012/12/bookshelf-based-random-adventure.html][http://2ndage.blogspot.com/]]                                              | Bookshelf-Based Random Adventure Generator   |
|                                                                          | *F*                                          |
| [[https://critical-hits.com/ch-presents/fantasy-name-generator/][https://critical-hits.com/]]                                               | Fantasy name generator                       |
|                                                                          | *G*                                          |
| https://www.gozzys.com/                                                  | Map generator                                |
|                                                                          | *P*                                          |
| https://purplesorcerer.com/                                              | Purple Sorcerer, tools for DCC               |
|                                                                          | *R*                                          |
| http://2ndage.blogspot.com/2012/12/bookshelf-based-random-adventure.html | Method for random scenario generation        |
| http://loukoum.online.fr/jdr/adj/gianni1.htm                             | (In French)                                  |
|                                                                          | *W*                                          |
