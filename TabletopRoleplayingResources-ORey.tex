...
The various folders contain TTRPG resources sorted by game (see also the \href{TabletopRoleplayingResources-ORey.pdf}{PDF version of this page}).

This repo is the 3rd one of a cycle:
\begin{itemize}
\item \href{https://github.com/orey/jdr}{github.com/orey/jdr} : French repo with a lot of TTRPG stuff and translations (in French)
